...
namespace QuickTalk.Api.Data.Migrations
{
    ...
    [Migration("20250202143026_UpdateChatroomTypeToString")]
    partial class UpdateChatroomTypeToString
    {
            ...
            modelBuilder.Entity("QuickTalk.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2025, 2, 2, 14, 30, 26, 450, DateTimeKind.Utc).AddTicks(7899),
