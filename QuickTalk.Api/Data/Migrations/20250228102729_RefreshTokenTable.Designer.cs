...
namespace QuickTalk.Api.Data.Migrations
{
    ...
    [Migration("20250228102729_RefreshTokenTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickTalk.Api.Models.RefreshToken", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuickTalk.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2025, 2, 28, 10, 27, 29, 77, DateTimeKind.Utc).AddTicks(5955),
            ...
            modelBuilder.Entity("QuickTalk.Api.Models.RefreshToken", b =>
                {
                    b.HasOne("QuickTalk.Api.Models.User", "User")
                        ...
                        .HasForeignKey("QuickTalk.Api.Models.RefreshToken", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
